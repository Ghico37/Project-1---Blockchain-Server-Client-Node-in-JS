...
// This section of code is responsible for block creationd the hash value. The SHA-256 hashing algorithim is for security.
// Hopefully this hashing algorithim will ensure that no two inputs create the same output.
// Additionally, the block object is essential for maintaining security on the blockchain. Each block, thanks to the constructor functions, will be marked with a timestamp, a list of transactions, its hash, and the previous block's hash.
// Mining is also specified here.